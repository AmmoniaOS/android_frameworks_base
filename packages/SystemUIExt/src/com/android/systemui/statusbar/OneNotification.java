...
public class OneNotification implements OneService.ApiUI {
    ...
    private final class Receiver extends BroadcastReceiver {
        ...
        public void init() {
            ...
            filter.addAction(Intent.ACTION_ONE_API);
            filter.addAction(Intent.ACTION_ONE_API_OTA);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(Intent.ACTION_ONE_API)) {
                showPushNotification(message);
            } else if (action.equals(Intent.ACTION_ONE_API_OTA)) {
                showOtaDialog(message);
            }
        }
    }
